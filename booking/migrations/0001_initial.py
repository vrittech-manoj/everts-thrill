    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_book_services', to='services.services')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_book_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airlines', models.CharField(blank=True, max_length=450, null=True)),
